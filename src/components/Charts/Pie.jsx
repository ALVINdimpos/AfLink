...
export class OverView extends SampleBase {
    ...
    pieTemplate() {
        return (<div className="template">
        <AccumulationChartComponent style={{ "height": "100%", "width": "100%" }} legendSettings={{ visible: false }} load={this.accumulationload.bind(this)} tooltip={{ enable: true, format: "${point.tooltip}" }} pointRender={this.onPointRender.bind(this)} enableSmartLabels={true} enableBorderOnMouseMove={false}>
